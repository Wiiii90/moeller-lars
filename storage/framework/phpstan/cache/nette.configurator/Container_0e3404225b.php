<?php
// source: phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar/conf/config.neon
// source: phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar/conf/config.level5.neon
// source: P:\moeller-lars-implementation\phpstan.neon
// source: array
...
class Container_0e3404225b extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [
			['051', '060', '0100', '0106', '0107', '0123', '0139', '0175'],
		],
		...
		'PHPStan\Collectors\Collector' => [1 => ['0787', '0788', '0789', '0790', '0791', '0792', '0793', '0794', '0795']],
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_0e3404225b $container)
			{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('P:\moeller-lars-implementation\storage\framework\phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_0e3404225b
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\FileFinder($this->getService('fileExcluderAnalyse'), $this->getService('0311'), ['php']);
	}


	public function createServiceFileFinderScan(): PHPStan\File\FileFinder
	{
		return new PHPStan\File\FileFinder($this->getService('fileExcluderScan'), $this->getService('0311'), ['php']);
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			'bootstrapFiles' => [
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionUnionType.php',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionAttribute.php',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\Attribute85.php',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionIntersectionType.php',
			],
			'excludePaths' => ['analyseAndScan' => [], 'analyse' => []],
			'level' => 5,
			'paths' => ['P:\moeller-lars-implementation\app'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'stubFiles' => [
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\Memcached.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\Redis.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionAttribute.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionClassConstant.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionFunctionAbstract.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionMethod.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionParameter.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionProperty.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\iterable.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ArrayObject.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\WeakReference.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ext-ds.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ImagickPixel.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\PDOStatement.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\date.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ibm_db2.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\mysqli.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\zip.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\dom.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\spl.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\SplObjectStorage.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\Exception.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\arrayFunctions.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\core.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\typeCheckingFunctions.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\Countable.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\file.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\stream_socket_client.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\stream_socket_server.stub',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\stubs\ctype.stub',
			],
			'earlyTerminatingMethodCalls' => [],
			'earlyTerminatingFunctionCalls' => [],
			'resultCachePath' => 'P:\moeller-lars-implementation\storage\framework\phpstan/resultCache.php',
			...
			'tmpDir' => 'P:\moeller-lars-implementation\storage\framework\phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => 'P:\moeller-lars-implementation\storage\framework\phpstan',
			'rootDir' => 'P:\moeller-lars-implementation\vendor\phpstan\phpstan',
			'currentWorkingDirectory' => 'P:\moeller-lars-implementation',
			'cliArgumentsVariablesRegistered' => true,
			'additionalConfigFiles' => [
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar/conf/config.level5.neon',
				'P:\moeller-lars-implementation\phpstan.neon',
			],
			'allConfigFiles' => [
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\conf\parametersSchema.neon',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\conf\config.level5.neon',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\conf\config.level4.neon',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\conf\config.level3.neon',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\conf\config.level2.neon',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\conf\config.level1.neon',
				'phar://P:\moeller-lars-implementation\vendor\phpstan\phpstan\phpstan.phar\conf\config.level0.neon',
				'P:\moeller-lars-implementation\phpstan.neon',
			],
			'composerAutoloaderProjectPaths' => ['P:/moeller-lars-implementation'],
			'generateBaselineFile' => null,
			'usedLevel' => '5',
			'cliAutoloadFile' => null,
			'env' => [
				'ALLUSERSPROFILE' => 'C:\ProgramData',
				'APPDATA' => 'C:\Users\Wiiii\AppData\Roaming',
				'BROWSER_USE_AVAILABLE_BACKENDS' => 'chrome,iab',
				'CABAL_DIR' => 'C:\cabal',
				'ChocolateyInstall' => 'C:\ProgramData\chocolatey',
				'ChocolateyLastPathUpdate' => '133969946145831783',
				'ChocolateyToolsLocation' => 'C:\tools',
				'CODEX_CI' => '1',
				'CODEX_INTERNAL_ORIGINATOR_OVERRIDE' => 'Codex Desktop',
				'CODEX_SANDBOX_NETWORK_DISABLED' => '1',
				'CODEX_SESSION_ID' => '01a001e2-bc5b-71e0-8fcc-5bbba393e294',
				'CODEX_THREAD_ID' => '01a001e2-bc5b-71e0-8fcc-5bbba393e294',
				'COLORTERM' => '',
				'COLUMNS' => '120',
				'CommonProgramFiles' => 'C:\Program Files\Common Files',
				'CommonProgramFiles(x86)' => 'C:\Program Files (x86)\Common Files',
				'CommonProgramW6432' => 'C:\Program Files\Common Files',
				'COMPUTERNAME' => 'WIIIIONE',
				'ComSpec' => 'C:\WINDOWS\system32\cmd.exe',
				'DriverData' => 'C:\Windows\System32\Drivers\DriverData',
				'GHCUP_INSTALL_BASE_PREFIX' => 'C:\\',
				'GH_PAGER' => 'cat',
				'GIT_PAGER' => 'cat',
				'GOPATH' => 'C:\Users\Wiiii\go',
				'HOMEDRIVE' => 'C:',
				'HOMEPATH' => '\Users\Wiiii',
				'JAVA_HOME' => 'C:\jdk-17',
				'JD2_HOME' => 'C:\Users\Wiiii\AppData\Local\JDownloader v2.0',
				'LANG' => 'C.UTF-8',
				'LC_ALL' => 'C.UTF-8',
				'LC_CTYPE' => 'C.UTF-8',
				'LINES' => '9001',
				'LOCALAPPDATA' => 'C:\Users\Wiiii\AppData\Local',
				'LOGONSERVER' => '\\\WIIIIONE',
				'LOG_FORMAT' => 'json',
				'M2' => 'C:\Maven\apache-maven-3.9.8\bin',
				'M2_HOME' => 'C:\Maven\apache-maven-3.9.8',
				'MAVEN_HOME' => 'C:\Maven\apache-maven-3.9.8',
				'NODE_REPL_TRUSTED_BROWSER_CLIENT_SHA256S' => '0b6d31ced7f1e01dcc1e3aba9416cb1ed01f17e76030ef4a4d1d3e19fd8e0bc6',
				'NODE_REPL_TRUSTED_CODE_PATHS' => 'C:\Users\Wiiii\.codex;C:\Users\Wiiii\AppData\Local\OpenAI\Codex\runtimes\cua_node\9ec47c3bbf131bc8\bin\node_modules',
				'NO_COLOR' => '1',
				'NUMBER_OF_PROCESSORS' => '16',
				'OneDrive' => 'C:\Users\Wiiii\OneDrive',
				'OneDriveConsumer' => 'C:\Users\Wiiii\OneDrive',
				'OPENSSL_CONF' => 'C:\Program Files\OpenSSL-Win64\bin\openssl.cfg',
				'OS' => 'Windows_NT',
				'PAGER' => 'cat',
				'Path' => 'C:\Program Files\PowerShell\7;C:\Users\Wiiii\.codex\tmp\arg0\codex-arg0j6LxQQ;C:\Users\Wiiii\.cache\codex-runtimes\codex-primary-runtime\dependencies\bin\override;C:\Program Files\Common Files\Oracle\Java\javapath;C:\jdk-17\bin;C:\Python310\Scripts\;C:\Python310\;C:\Program Files\ImageMagick-7.0.10-Q16;C:\Program Files (x86)\NVIDIA Corporation\PhysX\Common;C:\WINDOWS\system32;C:\WINDOWS;C:\WINDOWS\System32\Wbem;C:\WINDOWS\System32\WindowsPowerShell\v1.0\;C:\WINDOWS\System32\OpenSSH\;C:\Program Files\MiKTeX 2.9\miktex\bin\x64\;C:\ProgramData\chocolatey\bin;C:\Program Files\PuTTY\;C:\Program Files\PostgreSQL\13\bin;C:\Program Files\PostgreSQL\13\lib;C:\Maven\apache-maven-3.9.8\bin;C:\Program Files\MATLAB\R2023a\bin;C:\Program Files\Git\bin;C:\Gradle\gradle-8.8\bin;C:\Program Files (x86)\Incredibuild;C:\Program Files (x86)\Windows Kits\10\Windows Performance Toolkit\;C:\Program Files\doxygen\bin;C:\Program Files\Graphviz\bin;C:\Program Files\dotnet\;C:\Program Files\OpenSSL-Win64\bin;C:\Program Files\nodejs\;C:\Program Files\Docker\Docker\resources\bin;C:\Program Files\GitHub CLI\;C:\Program Files\CMake\bin;C:\Program Files\LLVM\bin;C:\QT\6.9.1\msvc2022_64\bin;;C:\WINDOWS\system32;C:\WINDOWS;C:\WINDOWS\System32\Wbem;C:\WINDOWS\System32\WindowsPowerShell\v1.0\;C:\WINDOWS\System32\OpenSSH\;C:\Program Files\PowerShell\7\;C:\Program Files\Go\bin;C:\Users\Wiiii\AppData\Local\Programs\Python\Python39\Scripts\;C:\Users\Wiiii\AppData\Local\Programs\Python\Python39\;C:\Users\Wiiii\.cargo\bin;C:\Program Files\MySQL\MySQL Shell 8.0\bin\;C:\Users\Wiiii\.cache\codex-runtimes\codex-primary-runtime\dependencies\native\powershell;C:\Users\Wiiii\AppData\Local\Microsoft\WindowsApps;C:\Users\Wiiii\AppData\Local\Programs\Microsoft VS Code\bin;C:\Users\Wiiii\AppData\Local\Programs\MiKTeX\miktex\bin\x64\;C:\Program Files\JetBrains\IntelliJ IDEA 2020.3.2\bin;C:\Program Files\JetBrains\IntelliJ IDEA Community Edition 2020.3.2\bin;C:\Users\Wiiii\AppData\Local\gitkraken\bin;C:\Users\Wiiii\AppData\Local\GitHubDesktop\bin;C:\Users\Wiiii\AppData\Local\Pandoc\;C:\Users\Wiiii\AppData\Roaming\cabal\bin;C:\tools\ghc-9.4.1\bin;C:\ghcup\bin;C:\Program Files\JetBrains\IntelliJ IDEA Community Edition 2023.2.5\bin;C:\Users\Wiiii\AppData\Local\JetBrains\Toolbox\scripts;C:\Users\Wiiii\AppData\Roaming\npm;C:\Program Files\OpenCppCoverage;C:\Users\Wiiii\AppData\Local\Microsoft\WinGet\Links;C:\Users\Wiiii\AppData\Local\Programs\Antigravity\bin;C:\Users\Wiiii\AppData\Local\Programs\cursor\resources\app\bin;P:\flutter\bin;C:\Users\Wiiii\AppData\Local\Microsoft\WindowsApps;C:\Users\Wiiii\.dotnet\tools;P:\.tools\git-lfs\3.7.1\git-lfs-3.7.1;C:\Users\Wiiii\.dotnet\tools;C:\Users\Wiiii\AppData\Local\Programs\Podman\;C:\Users\Wiiii\AppData\Local\Programs\pnpm;P:\.tools\JetBrains Rider 2026.2.0.2\bin;C:\Users\Wiiii\go\bin;C:\Program Files\NASM;C:\Users\Wiiii\.cache\codex-runtimes\codex-primary-runtime\dependencies\bin\fallback;C:\Users\Wiiii\.cache\codex-runtimes\codex-primary-runtime\dependencies\native\git\cmd;C:\Users\Wiiii\AppData\Local\OpenAI\Codex\bin\024312deab036740;C:\Program Files\WindowsApps\OpenAI.Codex_26.810.6296.0_x64__2p2nqsd0c76g0\app\resources',
				'PATHEXT' => '.COM;.EXE;.BAT;.CMD;.VBS;.VBE;.JS;.JSE;.WSF;.WSH;.MSC;.PY;.PYW;.CPL',
				'PIT_MUTATION_INTERCEPTOR' => 'org.apache.ibatis.mutationtesting.PredictiveMutationInterceptorFactory',
				...
				'PSModulePath' => 'C:\Users\Wiiii\Documents\PowerShell\Modules;C:\Program Files\PowerShell\Modules;c:\program files\powershell\7\Modules;C:\Program Files\WindowsPowerShell\Modules;C:\WINDOWS\system32\WindowsPowerShell\v1.0\Modules',
				'PUBLIC' => 'C:\Users\Public',
				'QtMsBuild' => 'C:\Users\Wiiii\AppData\Local\QtMsBuild',
				'RUST_LOG' => 'warn',
				'SHELL_VERBOSITY' => '0',
				'SystemDrive' => 'C:',
				'SystemRoot' => 'C:\WINDOWS',
				'TEMP' => 'C:\Users\Wiiii\AppData\Local\Temp',
				'TERM' => 'dumb',
				'TMP' => 'C:\Users\Wiiii\AppData\Local\Temp',
				'USERDOMAIN' => 'WIIIIONE',
				'USERDOMAIN_ROAMINGPROFILE' => 'WIIIIONE',
				'USERNAME' => 'Wiiii',
				'USERPROFILE' => 'C:\Users\Wiiii',
				'VCPKG_DEFAULT_BINARY_CACHE' => 'P:\vcpkg\binarycache',
				'VCPKG_INSTALLED_DIR' => 'P:\vcpkg\installed\fossredder',
				'VCPKG_ROOT' => 'P:\vcpkg',
				'windir' => 'C:\WINDOWS',
