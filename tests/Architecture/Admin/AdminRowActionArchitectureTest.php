...
it('keeps the shared semantic row-action primitive available without forcing accepted Journal or Custom Page markup through it', function (): void {
    ...
    foreach ([$pages, $dashboard] as $view) {
        expect($view)
