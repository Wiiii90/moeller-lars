...
| `site=litho` | `inc/config.php:102-110` (`litho` case) | Exposes “etching & lithography”. | Preserve the observed label as migration/editorial data, separately from the factual table list. | Reviewed category mapping. |
