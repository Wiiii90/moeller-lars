<x-filament-widgets::widget>
    <x-admin.workspace kicker="Contact & delivery" title="Contact form readiness">
        <x-slot:summary>
        ...
        <x-slot:actions>
            <a class="admin-action" href="{{ $generalUrl }}">General</a>
            <a class="admin-action" href="{{ $pagesUrl }}">Pages</a>
        </x-slot:actions>
