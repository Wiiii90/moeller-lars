...
final class MediaCapacityService
{
    ...
    /**
     * Return a presentation snapshot only when another surface has already measured it.
     * This method never falls back to snapshot(), so dashboard reads cannot trigger a filesystem walk.
     *
