...
#[Fillable(['blog_post_id', 'exhibition_id', 'media_asset_id', 'role', 'position', 'alt_text_override', 'embed_key'])]
#[Guarded(['id'])]
final class JournalEntryMedia extends Model
{
    ...
    public const ROLES = [self::ROLE_COVER, self::ROLE_INLINE, self::ROLE_GALLERY];
