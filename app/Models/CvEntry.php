...
/**
 * Historical migration compatibility model.
 *
 * CV entries are retained as provenance for the legacy public-profile import only;
 * they are not part of the active editorial or public runtime model.
 */
