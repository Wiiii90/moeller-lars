...
class PublicArtworkController extends Controller
{
    ...
    {
        $section = $this->sections->galleryBySlug($category);

        if ($section === null) {
            $redirect = $this->sections->redirect('/'.$category, SiteSectionPathPolicy::GALLERY_SLUG_REDIRECT_REASON);
    ...
    public function show(string $slug): View
    {
        ...
        abort_unless($this->sections->galleryExistsForCategory((int) $categoryRecord->getKey()), 404);
